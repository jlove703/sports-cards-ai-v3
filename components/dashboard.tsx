...
export default function Dashboard() {
  ...
  // Load data when page loads and every 30 seconds
  useEffect(() => {
    loadHotPlayers();
    const interval = setInterval(loadHotPlayers, 30000);
    return () => clearInterval(interval);
  }, []);

  return (
    <div className="p-8">
      <h1 className="text-3xl font-bold mb-8">Sports Cards Dashboard</h1>
